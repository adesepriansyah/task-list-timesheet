...
export default function DashboardPage() {
  ...
  return (
    <div className="flex min-h-screen bg-white dark:bg-zinc-950 font-[family-name:var(--font-geist-sans)] border-t-4 border-orange-500 transition-colors">
      {toast && (
        <Toast 
        ...
        <div className={activeTab === "tasks" ? "max-w-[1600px] mx-auto" : "max-w-6xl mx-auto"}>
          <header className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="animate-in slide-in-from-left duration-500">
              <h1 className="text-4xl font-black text-gray-900 dark:text-white tracking-tight uppercase italic decoration-orange-500 underline underline-offset-8">
                {activeTab}
              </h1>
            ...
            {activeTab === "tasks" && (
              <button 
                ...
                className="flex items-center gap-3 px-8 py-4 bg-zinc-900 dark:bg-orange-500 text-white rounded-2xl font-bold hover:scale-105 transition-all shadow-xl shadow-orange-500/20 active:scale-95"
              >
            ...
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-zinc-50 dark:bg-zinc-900 rounded-[2rem] p-10 border border-zinc-100 dark:border-zinc-800 shadow-sm">
                  <div className="w-14 h-14 bg-orange-100 dark:bg-orange-900/30 rounded-2xl flex items-center justify-center text-orange-600 dark:text-orange-400 mb-8">
                  ...
                  <p className="text-zinc-500 dark:text-zinc-400 leading-relaxed mb-8 text-xl font-medium">
                    Finished <span className="text-orange-500 font-black">{summary.completed} tasks</span>! 
                    Your current efficiency is at an all-time high.
                  </p>
                  <button 
                    onClick={() => setActiveTab("tasks")}
                    className="group px-10 py-4 bg-orange-500 text-white rounded-2xl font-black hover:bg-orange-600 transition-all flex items-center gap-3 uppercase tracking-wider"
                  >
                    View Logs
                ...
                <div className="bg-zinc-900 rounded-[2rem] p-10 text-white flex flex-col justify-center relative overflow-hidden ring-1 ring-white/10">
                  <div className="relative z-10">
                    <h3 className="text-3xl font-black mb-4 uppercase tracking-tighter text-orange-500">Quick Reminder</h3>
              ...
              <div className="bg-white dark:bg-zinc-900 p-6 rounded-3xl border border-zinc-100 dark:border-zinc-800 shadow-sm flex flex-col lg:flex-row items-center gap-6">
                <div className="relative w-full lg:w-96 group">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-700/50 rounded-2xl focus:ring-4 focus:ring-orange-500/10 focus:border-orange-500 transition-all outline-none text-sm font-bold text-zinc-900 dark:text-white placeholder:text-zinc-400 placeholder:font-medium"
                  />
                </div>
                ...
                <div className="flex items-center gap-4 w-full lg:w-auto">
                  ...
                  <div className="flex flex-1 lg:flex-initial items-center gap-2">
                    <input
                      type="date"
                      className="flex-1 lg:w-44 px-4 py-3 bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-700/50 rounded-xl focus:ring-4 focus:ring-orange-500/10 focus:border-orange-500 transition-all outline-none text-xs font-bold text-zinc-900 dark:text-white"
